...
object Doctor extends App {
  ...
  system.scheduler.scheduleOnce(200.millis) { heartLungMachine ! HeartLungMachine.PullBack(1f) }
  system.scheduler.scheduleOnce(1.seconds) { heartLungMachine ! HeartLungMachine.PullBack(0f) }
  system.scheduler.scheduleOnce(3.seconds) { heartLungMachine ! HeartLungMachine.PullBack(0.5f) }
  system.scheduler.scheduleOnce(4.seconds) { heartLungMachine ! HeartLungMachine.PullBack(0f) }
